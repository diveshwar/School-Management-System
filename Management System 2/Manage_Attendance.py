...
class Class_Attendance:
    ...
    def Attendance(self):
        conn = b=mysql.connector.connect(host="localhost",user="root",passwd='vighnesh123',database="employee")
        cur = conn.cursor()
    ...
    def ok_fun(self):
        conn =mysql.connector.connect(host="localhost",user="root",passwd='vighnesh123',database="employee")
        c = conn.cursor()
