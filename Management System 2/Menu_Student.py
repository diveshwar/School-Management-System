...
class Student_Menu:
    def __init__(self, root, ls, frame_old, frame_run, roll):
        ...
        # Labeling the page.
        self.title = Label(self.frame, text='TVD UNIVERSITY', font=('Algerian', 25, 'bold'), bg="#163148", fg="#ffffff").pack(
            side=TOP)
        ...
        self.title1 = Label(self.frame2, text='STUDENT PORTAL', font=('Algerian', 22, 'bold'), bg='#ffffff').pack(
            side=TOP)
